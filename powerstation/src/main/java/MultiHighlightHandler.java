...
//import static com.intellij.codeInsight.highlighting.HighlightUsagesHandler.isClearHighlights;
//import NamedTextAttr;
...
public class MultiHighlightHandler {
    ...
    public static void invoke(@NotNull Project project, @NotNull Editor editor,
        ...
        System.out.println("Entering handleCustomUsage");
        if (handleCustomUsage(editor, file)) {
            return;
        }
        System.out.println("handleCustomUsage was false");

        DumbService.getInstance(project).withAlternativeResolveEnabled(() -> {
            System.out.println("Entering findTarget");
            if (!findTarget(project, editor, file)) {
                System.out.println("Entering handleNoUsageTargets");
                handleNoUsageTargets(file, editor, project, start, end);
            }
        });
    }

    private static boolean handleCustomUsage(@NotNull Editor editor, @NotNull PsiFile file) {
        System.out.println("In handleCustomUsage");
...
//            final List writeUsages = handler.getWriteUsages();
    ...
    private static boolean findTarget(@NotNull Project project, @NotNull Editor editor,
        ...
        System.out.println("In findTarget");
        UsageTarget[] usageTargets = UsageTargetUtil.findUsageTargets(editor, file);
        System.out.println("findUsageTargets completed");
        if (usageTargets != null) {
            System.out.println("UsageTargets not null");
            ...
            System.out.println("UsageTargets is null");
            final PsiElement psiElement = findTargetElement(editor, file);
            System.out.println("finished findTargetElement");
            if (psiElement != null) {
                System.out.println("findTargetElement not null");
                highlightPsiElement(project, psiElement, editor, file, isClearHighlights(editor));
                System.out.println("finished highlightPsiElement");
            } else {
                boolean found = false;
    ...
    private static boolean isClearHighlights(@NotNull Editor editor) {
        System.out.println("In isClearHighlights");
    ...
    private static void handleNoUsageTargets(PsiFile file, @NotNull Editor editor,
                                             @NotNull Project project, int start, int end) {
        ...
        d.getText(new TextRange(start, end));
        //String selection = selectionModel.getSelectedText();
        String selection = d.getText(new TextRange(start, end));
